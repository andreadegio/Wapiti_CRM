import utils from 'vue-file-agent/src/lib/utils';
...
import FileRecord from 'vue-file-agent/src/lib/file-record';
import { RawFileRecord } from 'vue-file-agent/src/lib/file-record';
import uploader from 'vue-file-agent/src/lib/upload-helper';
import Vue from 'vue';
import plugins from 'vue-file-agent/src/lib/plugins';
import { ConfigureFn } from 'vue-file-agent/src/lib/ajax-request';
...
export default Vue.extend({
  ...
  methods: {
    ...
    upload(
      ...
      if (this.resumable) {
        // console.log("upload nel tusUpload");
      ...
      return new Promise((resolve, reject) => {
        uploader
          .upload(
            ...
            (overallProgress) => {
              this.overallProgress = overallProgress;
              // console.log("upload nel Promise");
            },
